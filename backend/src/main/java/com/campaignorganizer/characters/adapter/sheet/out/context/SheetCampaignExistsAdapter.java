...
/** ACL: resolves campaign existence for the sheet module via the campaign query port. */
@Component
public class SheetCampaignExistsAdapter implements CampaignExistsPort {

    private final CampaignQueryPort campaigns;

    public SheetCampaignExistsAdapter(CampaignQueryPort campaigns) {
