...
public final class CharacterSheetCommands {
    ...
    public record CreateCharacterSheetCommand(UUID worldId, UUID categoryId, UUID worldTemplateId,
                                               UUID globalTemplateId, UUID articleId, UUID campaignId,
                                               String name, Map<String, Object> values) {
    }

    public record UpdateCharacterSheetCommand(UUID worldId, UUID sheetId, UUID categoryId,
                                               UUID worldTemplateId, UUID globalTemplateId, UUID articleId,
