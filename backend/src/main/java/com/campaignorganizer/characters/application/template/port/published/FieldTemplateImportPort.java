...
/**
 * Published port: persists a field template exactly as given (id and
 ...
 */
public interface FieldTemplateImportPort {

    FieldTemplateView importFieldTemplate(FieldTemplateView view);
}
