...
/**
 * Published port: persists a handout category exactly as given (id and
 ...
 */
public interface HandoutCategoryImportPort {

    HandoutCategoryView importHandoutCategory(HandoutCategoryView view);
}
