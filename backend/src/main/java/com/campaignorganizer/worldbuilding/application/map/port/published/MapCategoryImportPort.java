...
/**
 * Published port: persists a map category exactly as given (id and foreign
 ...
 */
public interface MapCategoryImportPort {

    MapCategoryView importMapCategory(MapCategoryView view);
}
