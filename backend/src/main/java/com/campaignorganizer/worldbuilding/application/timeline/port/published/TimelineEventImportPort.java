...
/**
 * Published port: persists a timeline event exactly as given (id and foreign
 ...
 */
public interface TimelineEventImportPort {

    TimelineEventView importTimelineEvent(TimelineEventView view);
}
