...
function SidebarProvider({
  ...
  // Mirrors open/onOpenChange above, for the mobile Sheet's own open state —
  // lets a caller whose trigger button lives outside this provider's own
  // subtree (e.g. a top bar rendered as a sibling, not a descendant) still
  // control the mobile drawer.
  openMobile?: boolean
